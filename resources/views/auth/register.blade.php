...
<div class="main-login main-center">
        ...
        <div class="form-group{{ $errors->has('firstname') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="firstname" type="text" class="form-control" name="lastname" value="{{ old('firstname') }}" required autofocus>
            ...
            <div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="lastname" type="text" class="form-control" name="firstname" value="{{ old('lastname') }}" required autofocus>
